...
def openfilename():
    filename = filedialog.askopenfilename(title='',filetype=[("Image files", "*.png;*.jpg;*.jpeg")])
    return filename
def open_img():
    ...
    if x:
        ...
        if panelA is None or panelB is None:
            ...
            panelA.image = img
            panelA.pack(side="left", padx=20, pady=10)
            panelB = Label(image=img)
            panelB.image = img
            panelB.pack(side="right", padx=20, pady=10)
        else:
...
start1 = tk.Label(text="Pixel Manipulation", font=("Arial", 40), fg="green", bg= "black")
start1.place(x=350, y=10)

start1 = tk.Label(text="Original\nImage", font=("Arial", 40), fg="green",bg="black")
start1.place(x=100, y=270)

start1 = tk.Label(text="Encrypted\nImage", font=("Arial", 40), fg="green", bg="black")
start1.place(x=700, y=230)

chooseb = Button(window, text="Import", command=open_img, font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
chooseb.place(x=30, y=20)

saveb = Button(window, text="Exprot", command=save_img, font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
saveb.place(x=170, y=20)

enb = Button(window, text="Encrypt", command=lambda: en_fun(x), font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
enb.place(x=150, y=620)

deb = Button(window, text="Decrypt", command=de_fun, font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
deb.place(x=450, y=620)

resetb = Button(window, text="Reset", command=reset, font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
...
down_encrypted = Button(window, text="Download Encrypted", command=download_encrypted, font=("Arial", 15), bg="Black", fg="green", borderwidth=3, relief="raised")
down_encrypted.place(x=65, y=680)

down_decrypted = Button(window, text="Download Decrypted", command=download_decrypted, font=("Arial", 15), bg="black", fg="green", borderwidth=3, relief="raised")
down_decrypted.place(x=750, y=680)

def exit_win():
    if mbox.askokcancel("Exit", "Do you want to exit?"):
        window.destroy()

exitb = Button(window, text="EXIT", command=exit_win, font=("Arial", 20), bg="black", fg="blue", borderwidth=3, relief="raised")
